...
import com.yyc.stocktake.weight.recyclerview.DefineLoadMoreView
import com.google.android.material.floatingactionbutton.FloatingActionButton
import com.kingja.loadsir.core.LoadService
import com.kingja.loadsir.core.LoadSir
import com.yanzhenjie.recyclerview.SwipeRecyclerView
import com.yyc.stocktake.weight.loadCallBack.EmptyCallback
import com.yyc.stocktake.weight.loadCallBack.ErrorCallback
import com.yyc.stocktake.weight.loadCallBack.LoadingCallback
import com.yyc.stocktake.weight.viewpager.ScaleTransitionPagerTitleView
    ...
    commonNavigator.adapter = object : CommonNavigatorAdapter() {
        ...
        override fun getTitleView(context: Context, index: Int): IPagerTitleView {
            return ScaleTransitionPagerTitleView(appContext).apply {
                ...
                textSize = 20f
                //未选中颜色
                normalColor = appContext.getColor(R.color.black_121212)
                //选中颜色
                selectedColor = appContext.getColor(R.color.black_121212)
                //点击事件
                setOnClickListener {
        ...
        override fun getIndicator(context: Context): IPagerIndicator {
            return LinePagerIndicator(context).apply {
                ...
                //线条的颜色
                setColors(appContext.getColor(R.color.black_121212))
            }
        }
    }
