...
public class GridImageAdapter extends RecyclerView.Adapter<GridImageAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(final ViewHolder viewHolder, final int position) {
        ...
        if (getItemViewType(position) == TYPE_CAMERA) {
            ...
            if (chooseModel == SelectMimeType.ofAudio()) {
                ...
                viewHolder.tvDuration.setCompoundDrawablesRelativeWithIntrinsicBounds (com.luck.picture.lib.R.drawable.ps_ic_video, 0, 0, 0);
            }
            ...
            if (chooseModel == SelectMimeType.ofAudio()) {
                ...
                Glide.with(viewHolder.itemView.getContext())
                        ...
                        .centerCrop()
                        .placeholder(new ColorDrawable(Color.parseColor("#999999")))
    ...
    public interface OnItemLongClickListener {
        void onItemLongClick(ViewHolder viewHolder, int adapterPosition, View v);
    }
