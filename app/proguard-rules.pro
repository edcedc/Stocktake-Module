...
-keep public class * extends com.yyc.stocktake.mar.MyApplication
...
-keep class com.edc.xiaopao.v1.bean.** { *; }
...
-keep interface io.reactivex.rxjava3.android.** { *; }
